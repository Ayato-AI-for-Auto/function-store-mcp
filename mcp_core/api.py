...
async def create_function(func: FunctionCreate, user_id: str = Depends(get_current_user)):
    """
...
async def get_function_by_name(function_name: str, user_id: str = Depends(get_current_user)):
