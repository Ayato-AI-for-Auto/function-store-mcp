...
class SubprocessRuntime:
    ...
    """
    def run_function(self, code: str, test_cases: List[Dict], python_exe: str) -> Tuple[bool, str]:
        import tempfile
...
def _run_test_cases(code: str, test_cases: List[Dict], python_exe: str = sys.executable) -> Tuple[bool, str]:
