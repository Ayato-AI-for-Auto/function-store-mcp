...
from mcp_core.translation import TranslationService
...
class TestTranslationService(unittest.TestCase):
    ...
    @patch("mcp_core.translation.TranslationService.is_available")
    def test_translate_not_available(self, mock_available):
    ...
    @patch("mcp_core.translation.TranslationService.translate")
    @patch("mcp_core.translation.TranslationService.is_available")
    def test_ensure_bilingual_missing_en(self, mock_available, mock_translate):
    ...
    @patch("mcp_core.translation.TranslationService.translate")
    @patch("mcp_core.translation.TranslationService.is_available")
    def test_ensure_bilingual_missing_jp(self, mock_available, mock_translate):
        mock_available.return_value = True
    ...
    @patch("mcp_core.translation.TranslationService.translate")
    @patch("mcp_core.translation.TranslationService.is_available")
    def test_ensure_bilingual_both_missing_jp_source(self, mock_available, mock_translate):
        mock_available.return_value = True
        mock_translate.return_value = "Translated English"
    ...
    @patch("mcp_core.translation.TranslationService.translate")
    @patch("mcp_core.translation.TranslationService.is_available")
    def test_ensure_bilingual_failed_translation(self, mock_available, mock_translate):
        mock_available.return_value = True
